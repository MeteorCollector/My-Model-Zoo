...
class ConvModule(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Sequential(
            ConvBlock( 64, 192, 3, stride=1, padding=1),
            nn.MaxPool2d(2, stride=2),
        )

        self.conv3 = nn.Sequential(
            ConvBlock(192, 128, 1, stride=1, padding=0),
            ConvBlock(128, 256, 3, stride=1, padding=1),
            ConvBlock(256, 256, 1, stride=1, padding=0),
            ConvBlock(256, 512, 3, stride=1, padding=1),
            nn.MaxPool2d(2, stride=2),
        )

        self.conv4 = nn.Sequential(
            ConvBlock(512,  256, 1, stride=1, padding=0),
            ConvBlock(256,  512, 3, stride=1, padding=1),
            ConvBlock(512,  256, 1, stride=1, padding=0),
            ConvBlock(256,  512, 3, stride=1, padding=1),
            ConvBlock(512,  256, 1, stride=1, padding=0),
            ...
            ConvBlock(512,  256, 1, stride=1, padding=0),
            ConvBlock(256,  512, 3, stride=1, padding=1),
            ConvBlock(512,  512, 1, stride=1, padding=0),
            ConvBlock(512, 1024, 3, stride=1, padding=1),
            nn.MaxPool2d(2, stride=2),
        )

        self.conv5 = nn.Sequential(
            ConvBlock(1024,  512, 1, stride=1, padding=0),
            ConvBlock( 512, 1024, 3, stride=1, padding=1),
            ConvBlock(1024,  512, 1, stride=1, padding=0),
            ConvBlock( 512, 1024, 3, stride=1, padding=1),
            ConvBlock(1024, 1024, 3, stride=1, padding=1),
